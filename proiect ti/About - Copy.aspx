...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    <h2>
        <table id="Table1">
            ...
            <tr>
                <th style="height: 99px">Prenume</th>
                <th style="height: 99px">
    ...
    <h3>
        <asp:Button ID="btnAdaugaAngajat" runat="server" BackColor="#296C8D" Font-Bold="True" Font-Names="Arial Black" ForeColor="White" Height="36px" OnClick="btnAdaugaAngajat_Click" Style="position: absolute; float: left; margin-left: 200px; left: 254px; top: 1180px; width: 272px;" Text="Adauga Angajat" />
    </h3>
    <h3>Aici se pot adauga angajati noi</h3>
